...
public class Dec extends CodeObject
{
	VariableManager vm;
	int targetOperand = 0;
	...
	public Dec(boolean defaultObjectInput, VariableManager vmInput, int inputOperand, boolean inputAvailablePointer)
	{
	...
	public void run() throws InvalidArraySizeException, InvalidValueException, NumberFormatException
	{
		...
		{
			throw new NumberFormatException("오류 ! 문자를 뺄 수는 없습니다.");
		}
